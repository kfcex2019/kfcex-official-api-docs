...
2. 实际调用API 前，先调用 校时接口（https://api.kfcex.io/k/api/base//secret/v1/time）
...
testurl    = "https://api.kfcex.io/k/api/base/secret/v1/assetsList"

# 获取服务器端的时间
srvr_tm_api = "https://api.kfcex.io/k/api/base//secret/v1/time"
